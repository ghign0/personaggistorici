...
class __TwigTemplate_89875de5b92bb707bfd3e9dc01953f63d50f812219118034bd7b1e34649e3358 extends Twig_Template
{
...
";
    ...
    public function block_label($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute(($context["field"] ?? null), "help", array())) {
            ...
            if ($this->getAttribute(($context["field"] ?? null), "markdown", array())) {
                ...
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate(_twig_default_filter($this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFunction($this->getAttribute(($context["field"] ?? null), "label", array()), false), twig_capitalize_string_filter($this->env, $this->getAttribute(($context["field"] ?? null), "name", array())))), "html", null, true);
                echo "</span>
                            ";
            } else {
                // line 26
    ...
    public function block_input_attributes($context, array $blocks = array())
    {
        ...
        if (twig_in_filter($this->getAttribute(($context["field"] ?? null), "autocapitalize", array()), array(0 => "off", 1 => "characters", 2 => "words", 3 => "sentences"))) {
            echo "autocapitalize=\"";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["field"] ?? null), "autocapitalize", array()), "html", null, true);
            echo "\"";
        }
        // line 68
        echo "                                    ";
        if (twig_in_filter($this->getAttribute(($context["field"] ?? null), "inputmode", array()), array(0 => "none", 1 => "text", 2 => "decimal", 3 => "numeric", 4 => "tel", 5 => "search", 6 => "emaiil", 7 => "url"))) {
            echo "inputmode=\"";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["field"] ?? null), "inputmode", array()), "html", null, true);
            echo "\"";
        }
        // line 69
        echo "                                    ";
        if (twig_in_filter($this->getAttribute(($context["field"] ?? null), "spellcheck", array()), array(0 => "true", 1 => "false"))) {
            echo "spellcheck=\"";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["field"] ?? null), "spellcheck", array()), "html", null, true);
            echo "\"";
        }
        // line 70
        echo "
...
{% endblock %}
", "forms/default/field.html.twig", "/var/www/user/plugins/form/templates/forms/default/field.html.twig");
    }
}
